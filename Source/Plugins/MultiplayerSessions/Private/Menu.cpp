...
void UMenu::MenuSetup(int32 NumberOfPublicConnections, FString TypeOfMatch, FString LobbyPath)
{
	...
	if (MultiplayerSessionsSubsystem) {
		MultiplayerSessionsSubsystem->MultiplayerOnCreateCreateSessionComplete.AddDynamic(this, &ThisClass::OnCreateSession);
...
bool UMenu::Initialize()
{
	...
	if (OptionButton)
	{
		OptionButton->OnClicked.AddDynamic(this, &UMenu::OptionButtonClicked);
	}
	return true;
}
...
{
	MenuTearDown();
	if (OptionButton) OptionButton->OnClicked.RemoveDynamic(this, &UMenu::OptionButtonClicked);
...
void UMenu::OnCreateSession(bool bWasSuccessful)
{
	if (bWasSuccessful) {
		...
		GEngine->AddOnScreenDebugMessage(-1, 15.f, FColor::Yellow, FString(TEXT("Failed to create sessions")));
...
void UMenu::OptionButtonClicked()
{
